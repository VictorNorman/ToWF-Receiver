...
public abstract class PcmAudioDataPayload extends Payload implements Comparable<PcmAudioDataPayload> {
    ...
    public PcmAudioDataPayload(byte[] dgData) {
		//this.SeqId = new SeqId(Util.getIntFromByteArray(dgDataPayload, ADPL_HEADER_SEQ_ID_START, ADPL_HEADER_SEQ_ID_LENGTH, false));
        ...
        //AudioData = Arrays.copyOfRange(DgData, ADPL_HEADER_LENGTH, ADPL_HEADER_LENGTH + AudioDataAllocatedBytes);
        this.DgData = dgData;
	}
